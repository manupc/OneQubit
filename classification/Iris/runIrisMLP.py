...
import numpy as np
from DataLoaders import load_Iris
from SKLModels import SKLMLPClassifier as opt_algorithm
...
params['hidden_layer_sizes']= (200, 200)
params['alpha']= 0.001
params['solver']= 'adam'
params['metric']= 'perc_error' #: 'perc_error' / 'perc_accuracy'
