...
from DataLoaders import load_CartPole
...
params['buffer']['capacity']= 5000 #: Size of the buffer
...
runner.run(force_restart=RESTART, post_processing_outputs=serialize_model, debug=DEBUG)
