...
MaxEpisodes= 5000 # Maximum number of episodes to run
...
params['training_envs']= 1 #: Number of environments to populate buffer (default= 1)
...
params['buffer']['capacity']= 10000 #: Size of the buffer
...
params['exploration']['eps0']= 0.5 #: Initial epsilon for e-Greedy policy 
...
params['test']['steps']= 10 #: None, or int to set the number of algorithm iterations to wait before testing
